...
const rows: Row[] = [
  ...
  ["Measures download, upload and latency. Results are stored locally first.", "Mesure le téléchargement, l’envoi et la latence. Les résultats sont d’abord stockés localement.", "Misst Download, Upload und Latenz. Ergebnisse werden zuerst lokal gespeichert.", "Mide descarga, subida y latencia. Los resultados se guardan primero localmente.", "Mede download, upload e latência. Os resultados são armazenados primeiro localmente.", "Misura download, upload e latenza. I risultati vengono prima salvati localmente.", "डाउनलोड, अपलोड और विलंबता मापता है। परिणाम पहले स्थानीय रूप से सहेजे जाते हैं।"],
  ...
  ["Private by default · Local-first storage", "Privé par défaut · Stockage local en premier", "Standardmäßig privat · Lokale Speicherung zuerst", "Privado por defecto · Almacenamiento local primero", "Privado por padrão · Armazenamento local primeiro", "Privato per impostazione predefinita · Archiviazione locale prioritaria", "डिफ़ॉल्ट रूप से निजी · पहले स्थानीय संग्रह"],
  ...
  ["Select your provider", "Sélectionnez votre fournisseur", "Anbieter auswählen", "Selecciona tu proveedor", "Selecione seu provedor", "Seleziona il tuo operatore", "अपना प्रदाता चुनें"],
  ...
  ["LOCAL FIRST", "LOCAL D’ABORD", "LOKAL ZUERST", "LOCAL PRIMERO", "LOCAL PRIMEIRO", "PRIMA LOCALE", "पहले स्थानीय"],
  ["Your history is stored locally first", "Votre historique est d’abord stocké localement", "Ihr Verlauf wird zuerst lokal gespeichert", "Tu historial se guarda primero localmente", "Seu histórico é armazenado primeiro localmente", "La cronologia viene prima salvata localmente", "आपका इतिहास पहले स्थानीय रूप से सहेजा जाता है"],
  ...
  ["A VPN changes the route and can limit the speed. The result would measure the VPN path, not the connection delivered by your provider.", "Un VPN modifie le trajet réseau et peut limiter le débit. Le résultat mesurerait le trajet du VPN, pas la connexion fournie par votre opérateur.", "Ein VPN verändert den Netzwerkweg und kann die Geschwindigkeit begrenzen. Das Ergebnis würde den VPN-Weg messen, nicht die Verbindung Ihres Anbieters.", "Una VPN cambia la ruta y puede limitar la velocidad. El resultado mediría la ruta de la VPN, no la conexión entregada por tu proveedor.", "Uma VPN altera a rota e pode limitar a velocidade. O resultado mediria a rota da VPN, não a conexão entregue pelo provedor.", "Una VPN modifica il percorso e può limitare la velocità. Il risultato misurerebbe il percorso VPN, non la connessione fornita dall’operatore.", "VPN नेटवर्क मार्ग बदलता है और गति सीमित कर सकता है। परिणाम प्रदाता की कनेक्शन के बजाय VPN मार्ग को मापेगा।"],
  ["FiberPulse detected that this Mac is using Wi-Fi. You can continue, but the result may include Wi-Fi distance, walls and interference.", "FiberPulse a détecté que cet ordinateur utilise le Wi-Fi. Vous pouvez continuer, mais le résultat peut inclure l’effet de la distance, des murs et des interférences.", "FiberPulse hat erkannt, dass dieser Computer WLAN verwendet. Sie können fortfahren, das Ergebnis kann jedoch Entfernung, Wände und Störungen enthalten.", "FiberPulse detectó que este equipo usa Wi-Fi. Puedes continuar, pero el resultado puede incluir distancia, paredes e interferencias.", "O FiberPulse detectou que este computador usa Wi-Fi. Você pode continuar, mas o resultado pode incluir distância, paredes e interferências.", "FiberPulse ha rilevato che questo computer usa il Wi-Fi. Puoi continuare, ma il risultato può includere distanza, pareti e interferenze.", "FiberPulse ने पाया कि यह कंप्यूटर Wi-Fi उपयोग कर रहा है। आप जारी रख सकते हैं, लेकिन परिणाम में दूरी, दीवारों और हस्तक्षेप का असर हो सकता है।"],
  ["Checking…", "Vérification…", "Prüfung…", "Comprobando…", "Verificando…", "Verifica…", "जाँच हो रही है…"],
  ["VPN is off — start test", "Le VPN est désactivé — lancer le test", "VPN ist aus — Test starten", "La VPN está desactivada — iniciar prueba", "A VPN está desativada — iniciar teste", "La VPN è disattivata — avvia il test", "VPN बंद है — परीक्षण शुरू करें"],
  ["Open settings", "Ouvrir les réglages", "Einstellungen öffnen", "Abrir ajustes", "Abrir configurações", "Apri impostazioni", "सेटिंग्स खोलें"],
  ["Close settings", "Fermer les réglages", "Einstellungen schließen", "Cerrar ajustes", "Fechar configurações", "Chiudi impostazioni", "सेटिंग्स बंद करें"],
  ["Close plan selection", "Fermer le choix de l’offre", "Tarifauswahl schließen", "Cerrar selección de tarifa", "Fechar seleção do plano", "Chiudi selezione dell’offerta", "प्लान चयन बंद करें"],
  ["Close subscriber profile", "Fermer le profil de l’abonné", "Teilnehmerprofil schließen", "Cerrar perfil del abonado", "Fechar perfil do assinante", "Chiudi profilo dell’abbonato", "ग्राहक प्रोफ़ाइल बंद करें"],
  ["Close complaint preview", "Fermer l’aperçu de la réclamation", "Beschwerdevorschau schließen", "Cerrar vista previa de la reclamación", "Fechar prévia da reclamação", "Chiudi anteprima del reclamo", "शिकायत पूर्वावलोकन बंद करें"],
  ["Diagnostics summary", "Résumé des diagnostics", "Diagnoseübersicht", "Resumen de diagnóstico", "Resumo dos diagnósticos", "Riepilogo diagnostico", "निदान सारांश"],
  ["Latest speed test", "Dernier test de débit", "Letzter Geschwindigkeitstest", "Última prueba de velocidad", "Teste de velocidade mais recente", "Ultimo test di velocità", "नवीनतम स्पीड टेस्ट"],
  ["Speed history chart", "Graphique de l’historique des débits", "Diagramm des Geschwindigkeitsverlaufs", "Gráfico del historial de velocidad", "Gráfico do histórico de velocidade", "Grafico dello storico velocità", "गति इतिहास चार्ट"],
  ["Sponsored partner message", "Message d’un partenaire sponsorisé", "Nachricht eines gesponserten Partners", "Mensaje de un socio patrocinado", "Mensagem de parceiro patrocinado", "Messaggio di un partner sponsorizzato", "प्रायोजित साझेदार संदेश"],
  ["FiberPulse account", "Compte FiberPulse", "FiberPulse-Konto", "Cuenta FiberPulse", "Conta FiberPulse", "Account FiberPulse", "FiberPulse खाता"],
  ["Use the same history on macOS, Windows and the web", "Retrouvez le même historique sur macOS, Windows et le Web", "Denselben Verlauf auf macOS, Windows und im Web verwenden", "Usa el mismo historial en macOS, Windows y la Web", "Use o mesmo histórico no macOS, Windows e na Web", "Usa la stessa cronologia su macOS, Windows e Web", "macOS, Windows और वेब पर वही इतिहास उपयोग करें"],
  ["Finish signing in in your browser", "Terminez la connexion dans votre navigateur", "Anmeldung im Browser abschließen", "Finaliza el inicio de sesión en el navegador", "Conclua o login no navegador", "Completa l’accesso nel browser", "ब्राउज़र में साइन इन पूरा करें"],
  ["Sync now", "Synchroniser maintenant", "Jetzt synchronisieren", "Sincronizar ahora", "Sincronizar agora", "Sincronizza ora", "अभी सिंक करें"],
  ["Disconnect", "Déconnecter", "Trennen", "Desconectar", "Desconectar", "Disconnetti", "डिस्कनेक्ट करें"],
  ["Connect", "Connecter", "Verbinden", "Conectar", "Conectar", "Connetti", "कनेक्ट करें"],
  ["Waiting…", "En attente…", "Warten…", "Esperando…", "Aguardando…", "In attesa…", "प्रतीक्षा…"],
  ["Local simulation", "Simulation locale", "Lokale Simulation", "Simulación local", "Simulação local", "Simulazione locale", "स्थानीय सिमुलेशन"],
  ["Run a test to compare", "Lancez un test pour comparer", "Zum Vergleichen einen Test starten", "Realiza una prueba para comparar", "Execute um teste para comparar", "Avvia un test per confrontare", "तुलना के लिए परीक्षण चलाएँ"],
  ["In line with your plan", "Conforme à votre offre", "Im Rahmen Ihres Tarifs", "En línea con tu tarifa", "Dentro do esperado para o plano", "In linea con la tua offerta", "आपके प्लान के अनुरूप"],
  ["Slower than your plan", "Plus lent que votre offre", "Langsamer als Ihr Tarif", "Más lento que tu tarifa", "Mais lento que o plano", "Più lento della tua offerta", "आपके प्लान से धीमा"],
  ["Well below your plan", "Très inférieur à votre offre", "Deutlich unter Ihrem Tarif", "Muy por debajo de tu tarifa", "Muito abaixo do plano", "Molto sotto la tua offerta", "आपके प्लान से बहुत कम"],
  ["of advertised", "du débit annoncé", "der beworbenen", "de lo anunciado", "do anunciado", "del valore pubblicizzato", "विज्ञापित गति का"],
  ["Speed below your plan", "Débit inférieur à votre offre", "Geschwindigkeit unter Ihrem Tarif", "Velocidad inferior a tu tarifa", "Velocidade abaixo do plano", "Velocità inferiore alla tua offerta", "गति आपके प्लान से कम"],
  ["issues detected", "problèmes détectés", "Probleme erkannt", "problemas detectados", "problemas detectados", "problemi rilevati", "समस्याएँ मिलीं"],
  ["detected", "détecté(s)", "erkannt", "detectados", "detectados", "rilevati", "मिले"],
  ["Mbps measured", "Mbit/s mesurés", "Mbit/s gemessen", "Mbps medidos", "Mbps medidos", "Mbps misurati", "Mbps मापे गए"],
  ["of your", "de votre offre à", "Ihres", "de tu tarifa de", "do seu plano de", "della tua offerta da", "आपके"],
  ["Mbps plan", "Mbit/s", "Mbit/s-Tarifs", "Mbps", "Mbps", "Mbps", "Mbps प्लान का"],
  ["plus", "plus", "plus", "más", "mais", "più", "साथ में"],
  ["network incident", "incident réseau", "Netzwerkvorfall", "incidencia de red", "incidente de rede", "incidente di rete", "नेटवर्क घटना"],
  ["network incidents", "incidents réseau", "Netzwerkvorfälle", "incidencias de red", "incidentes de rede", "incidenti di rete", "नेटवर्क घटनाएँ"],
  ["Latest network incident", "Dernier incident réseau", "Letzter Netzwerkvorfall", "Última incidencia de red", "Incidente de rede mais recente", "Ultimo incidente di rete", "नवीनतम नेटवर्क घटना"],
  ["other", "Autre", "Andere", "Otro", "Outro", "Altro", "अन्य"],
  ["insufficient", "Insuffisante", "Unzureichend", "Insuficiente", "Insuficiente", "Insufficiente", "अपर्याप्त"],
  ["Build a credible complaint automatically", "Constituez automatiquement une réclamation crédible", "Glaubwürdige Beschwerde automatisch erstellen", "Crea automáticamente una reclamación creíble", "Crie automaticamente uma reclamação consistente", "Crea automaticamente un reclamo credibile", "स्वचालित रूप से विश्वसनीय शिकायत बनाएँ"],
  ["Your complaint package is ready", "Votre dossier de réclamation est prêt", "Ihre Beschwerdeunterlagen sind bereit", "Tu expediente de reclamación está listo", "Seu dossiê de reclamação está pronto", "Il dossier di reclamo è pronto", "आपका शिकायत पैकेज तैयार है"],
  ["READY", "PRÊT", "BEREIT", "LISTO", "PRONTO", "PRONTO", "तैयार"],
  ["COLLECTING", "COLLECTE", "SAMMLUNG", "RECOPILANDO", "COLETANDO", "RACCOLTA", "संग्रह"],
  ["Required", "Requis", "Erforderlich", "Obligatorio", "Obrigatório", "Obbligatorio", "आवश्यक"],
  ["Collecting", "Collecte", "Sammlung", "Recopilando", "Coletando", "Raccolta", "संग्रह"],
  ["7-day median vs plan", "Médiane sur 7 jours par rapport à l’offre", "7-Tage-Median gegenüber Tarif", "Mediana de 7 días frente a la tarifa", "Mediana de 7 dias versus plano", "Mediana di 7 giorni rispetto all’offerta", "7-दिन का माध्य बनाम प्लान"],
  ["Use the verified support page or add the contact printed on your bill.", "Utilisez la page d’assistance vérifiée ou ajoutez le contact figurant sur votre facture.", "Verwenden Sie die verifizierte Supportseite oder den Kontakt auf Ihrer Rechnung.", "Usa la página de soporte verificada o añade el contacto de tu factura.", "Use a página de suporte verificada ou adicione o contato da fatura.", "Usa la pagina di assistenza verificata o aggiungi il contatto indicato in fattura.", "सत्यापित सहायता पृष्ठ उपयोग करें या बिल पर दिया संपर्क जोड़ें।"],
  ["Complete subscriber profile", "Compléter le profil de l’abonné", "Teilnehmerprofil vervollständigen", "Completar perfil del abonado", "Completar perfil do assinante", "Completa il profilo dell’abbonato", "ग्राहक प्रोफ़ाइल पूरा करें"],
  ["Edit subscriber profile", "Modifier le profil de l’abonné", "Teilnehmerprofil bearbeiten", "Editar perfil del abonado", "Editar perfil do assinante", "Modifica il profilo dell’abbonato", "ग्राहक प्रोफ़ाइल संपादित करें"],
  ["Download complaint PDF", "Télécharger le PDF de réclamation", "Beschwerde-PDF herunterladen", "Descargar PDF de reclamación", "Baixar PDF da reclamação", "Scarica il PDF del reclamo", "शिकायत PDF डाउनलोड करें"],
  ["Creating PDF…", "Création du PDF…", "PDF wird erstellt…", "Creando PDF…", "Criando PDF…", "Creazione PDF…", "PDF बनाया जा रहा है…"],
  ["Email file + PDF attached", "Fichier e-mail avec PDF joint", "E-Mail-Datei mit angehängtem PDF", "Archivo de correo con PDF adjunto", "Arquivo de e-mail com PDF anexado", "File e-mail con PDF allegato", "PDF संलग्न ईमेल फ़ाइल"],
  ["Creating email…", "Création de l’e-mail…", "E-Mail wird erstellt…", "Creando correo…", "Criando e-mail…", "Creazione e-mail…", "ईमेल बनाया जा रहा है…"],
  ["Qualified tests · target", "Tests qualifiés · objectif", "Qualifizierte Tests · Ziel", "Pruebas válidas · objetivo", "Testes qualificados · meta", "Test qualificati · obiettivo", "योग्य परीक्षण · लक्ष्य"],
  ["qualified", "qualifiés", "qualifiziert", "válidas", "qualificados", "qualificati", "योग्य"],
  ["Select the Internet offer shown on the latest bill.", "Sélectionnez l’offre Internet indiquée sur la dernière facture.", "Wählen Sie den Internettarif auf der letzten Rechnung.", "Selecciona la tarifa de Internet de la última factura.", "Selecione o plano de Internet da fatura mais recente.", "Seleziona l’offerta Internet indicata nell’ultima fattura.", "नवीनतम बिल पर दिया इंटरनेट प्लान चुनें।"],
  ["Add the account holder, account number, and service address.", "Ajoutez le titulaire du compte, le numéro de compte et l’adresse du service.", "Fügen Sie Kontoinhaber, Kundennummer und Anschlussadresse hinzu.", "Añade el titular, el número de cuenta y la dirección del servicio.", "Adicione o titular, o número da conta e o endereço do serviço.", "Aggiungi intestatario, numero cliente e indirizzo del servizio.", "खाताधारक, खाता संख्या और सेवा पता जोड़ें।"],
  ["The seven-day median is not currently below the conservative 70% threshold.", "La médiane sur sept jours n’est actuellement pas inférieure au seuil prudent de 70 %.", "Der Sieben-Tage-Median liegt derzeit nicht unter der vorsichtigen 70-%-Schwelle.", "La mediana de siete días no está por debajo del umbral conservador del 70 %.", "A mediana de sete dias não está abaixo do limite conservador de 70%.", "La mediana di sette giorni non è sotto la soglia prudente del 70%.", "सात-दिन का माध्य अभी सावधान 70% सीमा से कम नहीं है।"],
  ["VPN detected: disconnect it before running a speed test", "VPN détecté : déconnectez-le avant de lancer un test de débit", "VPN erkannt: vor dem Geschwindigkeitstest trennen", "VPN detectada: desconéctala antes de la prueba", "VPN detectada: desconecte-a antes do teste", "VPN rilevata: disconnettila prima del test", "VPN मिला: स्पीड टेस्ट से पहले इसे बंद करें"],
...
function translateText(locale: Locale, source: string) {
  ...
  const patterns: Array<[RegExp, (match: RegExpMatchArray) => string]> = [
    ...
    [/^Qualified tests · target (\d+)$/, m => `${translate(locale, "Qualified tests · target")} ${m[1]}`],
    [/^(\d+) qualified$/, m => `${m[1]} ${translate(locale, "qualified")}`],
    [/^Collect (\d+) more qualified test\(s\)\.$/, m => ({ en: `Collect ${m[1]} more qualified test(s).`, fr: `Collectez encore ${m[1]} test(s) qualifié(s).`, de: `Erfassen Sie noch ${m[1]} qualifizierte Tests.`, es: `Recopila ${m[1]} pruebas válidas más.`, "pt-BR": `Colete mais ${m[1]} testes qualificados.`, it: `Raccogli altri ${m[1]} test qualificati.`, hi: `${m[1]} और योग्य परीक्षण एकत्र करें।` })[locale]],
    [/^Continue monitoring on (\d+) more day\(s\)\.$/, m => ({ en: `Continue monitoring on ${m[1]} more day(s).`, fr: `Poursuivez la surveillance pendant encore ${m[1]} jour(s).`, de: `Überwachen Sie noch ${m[1]} weitere Tage.`, es: `Continúa la supervisión durante ${m[1]} día(s) más.`, "pt-BR": `Continue monitorando por mais ${m[1]} dia(s).`, it: `Continua il monitoraggio per altri ${m[1]} giorni.`, hi: `${m[1]} और दिन निगरानी जारी रखें।` })[locale]],
