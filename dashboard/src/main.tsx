...
function App() {
  ...
  return <main class="shell">
    ...
    <section class="grid">
      <article class="panel wide"><div class="panel-head"><div><p class="eyebrow">13-month local history</p><h2>Performance trend</h2></div><a class="button ghost" href="/api/v1/export/csv">Export CSV</a></div><PerformanceChart measurements={measurements} /></article>
