...
type Status = { version: string; state: string; test_state: string; scheduler_state: string; paused: boolean; next_automatic_test?: string; provider: { name: string; enabled: boolean }; mlab_consent: Consent; sharing_consent: Consent; sharing_state: string; sharing_available: boolean; last_health: Health; measurements: Measurement[]; share_queue_count: number; baseline: Baseline; incidents: Incident[]; reports: Report[]; last_error?: string };
