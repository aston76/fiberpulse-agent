...
function ConsentCard({ scope, consent, title, children, review, onChange }: { scope: string; consent: Consent; title: string; children: preact.ComponentChildren; review: ConsentReview; onChange: (granted: boolean) => Promise<void> }) {
